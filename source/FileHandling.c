...
int loadSettings() {
	...
	g_dipSwitch0 = cfg.dipSwitchJK0;
	g_dipSwitch1 = cfg.dipSwitchJK1;
	g_dipSwitch2 = cfg.dipSwitchJK2;
	g_dipSwitch3 = cfg.dipSwitchJK3;
...
void saveSettings() {
	...
	cfg.dipSwitchJK0 = g_dipSwitch0;
	cfg.dipSwitchJK1 = g_dipSwitch1;
	cfg.dipSwitchJK2 = g_dipSwitch2;
	cfg.dipSwitchJK3 = g_dipSwitch3;
