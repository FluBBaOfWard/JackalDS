...
int loadSettings() {
	...
	gDipSwitch0  = cfg.dipSwitchJK0;
	gDipSwitch1  = cfg.dipSwitchJK1;
	gDipSwitch2  = cfg.dipSwitchJK2;
	gDipSwitch3  = cfg.dipSwitchJK3;
...
void saveSettings() {
	...
	cfg.dipSwitchJK0 = gDipSwitch0;
	cfg.dipSwitchJK1 = gDipSwitch1;
	cfg.dipSwitchJK2 = gDipSwitch2;
	cfg.dipSwitchJK3 = gDipSwitch3;
